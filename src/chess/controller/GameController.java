...
public class GameController {
    ...
    public synchronized void startNewGame(String white, String black) {
        startNewGame(PlayerController.getInstance().makePlayer(white, Color.WHITE), PlayerController.getInstance()
    ...
    public synchronized void reportNewMove(Player player, Field sourceField, Field targetField)
    ...
    private boolean isMoveLegal(Field sourceField, Field targetField) {
        ...
        return piece.getAllLegalMoves(board, sourceField.getX(), sourceField.getY()).contains(targetField);
    }
    ...
    private IMoveListener getMoveListener() {
        return new IMoveListener() {
            ...
            public void reportNewMove(Player player, Field sourceField, Field targetField)
                    throws UnauthorizedMoveException {
                GameController.getInstance().reportNewMove(player, sourceField, targetField);
            }
        };
    }
