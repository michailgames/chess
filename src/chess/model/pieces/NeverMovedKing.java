...
public class NeverMovedKing extends King {
	...
	private final static NeverMovedKing whiteKing =
			new NeverMovedKing(Color.WHITE);
	private final static NeverMovedKing blackKing =
			new NeverMovedKing(Color.BLACK);
