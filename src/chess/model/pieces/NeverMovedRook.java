...
/**
 * Projekt: Szachy
 * Reprezentacja nigdy nie poruszonego króla
 * Micha³ Rapacz
 * 2015-05-09
 */
...
public class NeverMovedRook extends Rook {
	...
	private final static NeverMovedRook whiteRook =
			new NeverMovedRook(Color.WHITE);
	private final static NeverMovedRook blackRook =
			new NeverMovedRook(Color.BLACK);
